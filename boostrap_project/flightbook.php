...
<body>
    <center>
      <u><h1>AIR LINE</h1></u>
      <img src="airplane.png" height="200" width="200">
    


  </center>
    <marquee scrollamount="20"><h1 class="text-secondary">Book your flight tickets here!!</h1></marquee>
    <u><center><h3 class="text-primary">Booking Form</h3></u></center>
      <div class="centerform">
      <form class="bg-secondary" method="POST" action="#" id="form" class="container-fluid" style="justify-content: center;">
       <table align="center">
        <tr>
          <td>CustomerName</td>
...
function validate(){
    ...
    let package=document.getElementById("flight");
    let validpack=false;
    if(package.value=="choose"){
        setError(package,"*please select a flight");
        validpack=false;
    }
    else{
        setSuccess(package);
...
table, th, td {
  border:1px solid black;
    ...
    <body>
      ...
      <h2 class='text-center'>Sucessfully Booked your Flight Tickets!!</h2><br>
